...
extension PDFViewController {
    ...
    public class func createNew(with document: PDFDocument, title: String? = nil, backButton: UIBarButtonItem? = nil, isThumbnailsEnabled: Bool = true) -> PDFViewController {
...
public final class PDFViewController: UIViewController,UIDocumentInteractionControllerDelegate {
